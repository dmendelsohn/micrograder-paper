...
An input request is a message from the client to the server that specifies one or more input channels for which a value is required.  Typically, this means that the student's program is attempting to sample a TODO: describe input requests
...
TODO discuss why a thin wrapper client is used, and how that works
