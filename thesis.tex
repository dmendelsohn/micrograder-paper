...
TODO: like old version, but better visual presentation of eval point in a table, and a worked example using Wikipedia Scroller (build on frame example above)

\subsection{Evaluation of outputs (depracated)}
