...
TODO: blinky example, with 2 blinks

TODO: break up problem into HI LO HI LO, introduce evaluation point to check each part

\subsubsection{Basic attributes of an evaluation point}
TODO: evaluation point has channel and expected value, obviously.  What about timing?  Interval relative to a condition.  Result? A boolean.

\subsubsection{Augmenting the evaluation point for increased flexibility}
TODO: portion allows for timing flexibility

TODO: check function allows for value flexibility

\subsubsection{Evaluation point examples}
TODO: Complete table for blinky problem, 4 points

TODO: example of "A" right after first Wikipedia scroller long press
