...
TODO: explain table and explain how  templates help us fill in the missing fields

TODO: mention how aggregation happens

\subsection{Auto-generated test case for Wikipedia Scroller}
To demonstrate the capability of the test construction algorithm, we used it to build a test for Wikipedia Scroller.  For our scaffold, we started with the frames from Table \ref{table:frame-templates}.  TODO: "the following figures show the inputs for each channel"

TODO: figures

The exercise has a single output channel, represented as a 128x64, bit map.  For that channel, (TODO: describe template).  TODO: "the following table shows the evaluation points
