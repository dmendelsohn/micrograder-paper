...
If the message is an observation, such as an embedded system output or an important internal event, the observation and its timestamp are logged.  TODO: in addition, each input frame's conditions are updated live.  TODO: respond or nah?
...
\subsection{Configurability (TODO: edit)}
