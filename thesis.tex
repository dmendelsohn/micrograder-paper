...
TODO: describe analog params and digital values
...
0x41 & Screen Full & $<$tile$>$* \\
0x42 & Screen Tile & $<$uint8 x position$>$$<$uint8 y position$>$$<$tile$>$ \\
\end{tabular}
\end{center}
