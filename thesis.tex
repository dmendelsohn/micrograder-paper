...
TODO: condition data structure.  Similar to old version, but give more examples and talk more explicitly about composition.  E.g. how would you use conditions to say "the second HTTP response"?  Also need to discuss what sorts of events we have access to  (reading inputs, actuating outputs, and a selection of internal events)
