...
TODO discuss why a thin wrapper client is used (minimal interference)

TODO describe how we have developed one implementation, but others are possible.  The communication protocol itself is not platform-specific
