...
Before diving into technical details of the automated grader, it helps to have a motivating example in mind.  The spring 2017 offering of 6.S08 at MIT included an exercise called ``Wikipedia Scroller".
...
In this paper, I will describe the approach I took with MicroGrader, and how it can be used to automatically grade this assignment.  This automatic process would give students instant feedback, and save many hours of the teaching assistants' time. 
...
\subsubsection{Re-examining Wikipedia Scroller}
